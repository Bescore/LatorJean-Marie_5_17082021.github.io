...
La branche "main" contient le projet structuré tel que je l'ais construit, et la branche application est la branche permettant de deployer le projet en github pages par l'intermédiare d'heroku et donc de pouvoir l'afficher sans que l'utilisateur ait à cloner le repo pour demarrer l'api ! Si cela ne fonctionne pas (à caue des limitations heroku), il faudra passer par la méthode classique, cloner le repo,  suivre les instructions plus haut, demarrer le serveur et ouvrir l'index.
